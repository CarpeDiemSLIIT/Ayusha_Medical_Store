...
const ProfileView = () => {
  ...
  const fetchUserData = async () => {
    const response = await fetch(`http://localhost:3001/api/store-front/client-auth/${_id}`, {
    });
  ...
  return (
    <div>
      <Box>
        <Typography sx={{width:800,margin:"auto",padding:"20px"}} variant="h4">
          My Profile
        </Typography>
        <Box sx={{ flexGrow: 1, overflow: 'hidden', px: 3 }}>
          <StyledPaper sx={{my: 1, mx: 'auto', p: 2}} elevation={0}>
            <Grid container wrap="nowrap" spacing={2}>
              ...
              <Grid item xs>
                <Typography sx={{fontSize: "1.2rem", fontWeight: 'bold' }} textAlign="left">User name</Typography>
                <Typography sx={{ fontSize: "1rem" }} textAlign="left">{userData.username}</Typography>
              </Grid>
            </Grid>
          </StyledPaper>
          <StyledPaper sx={{my: 1, mx: 'auto', p: 2}} elevation={0}>
            <Grid container wrap="nowrap" spacing={2}>
              ...
              <Grid item xs >
                    ...
                    <Typography sx={{ fontSize: "1rem" }} textAlign="left">{userData.firstName}</Typography>
                </Grid>
                </Grid>
            </StyledPaper>
            <StyledPaper
                ...
                <Grid item xs>
                    ...
                    <Typography sx={{ fontSize: "1rem"  }} textAlign="left">{userData.email}</Typography>
                </Grid>
                </Grid>
            </StyledPaper>
            <StyledPaper
                ...
                <Grid item xs>
                    ...
                    <Typography sx={{ fontSize: "1rem" }} textAlign="left">{userData.phoneNumber}</Typography>
                </Grid>
                </Grid>
            </StyledPaper>
            </Box>
